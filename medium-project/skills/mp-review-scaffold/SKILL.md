...
1. 搜索现有 Issue：`gh issue list --label "type:scaffold" --search "脚手架 in:title" --state open --json number --jq '.[0].number'`
2. 如果未找到，创建：`gh issue create --title "脚手架" --label "type:scaffold" --body "跟踪脚手架的 Review 过程。"`
