...
`python medium-project/scripts/mp-issue-helper.py find-or-create --label "type:task-split" --search "任务拆分" --create-title "任务拆分" --create-body "跟踪任务拆分的 Review 过程。" --comment "<Review 结果>"`
将同样的结果输出给技术负责人。
