...
`python medium-project/scripts/mp-issue-helper.py find-or-create --label "type:architecture" --search "架构设计" --create-title "架构设计" --create-body "跟踪系统架构的 Review 过程。" --comment "<Review 结果>"`
将同样的结果输出给技术负责人。
