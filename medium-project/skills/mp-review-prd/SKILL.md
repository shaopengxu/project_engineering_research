...
1. 搜索现有 Issue：`gh issue list --label "type:prd-review" --search "PRD Review in:title" --state open --json number --jq '.[0].number'`
2. 如果未找到，创建：`gh issue create --title "PRD Review" --label "type:prd-review" --body "跟踪 PRD 的 Review 过程。"`
