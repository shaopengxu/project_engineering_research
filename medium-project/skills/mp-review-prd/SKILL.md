...
`python medium-project/scripts/mp-issue-helper.py find-or-create --label "type:prd-review" --search "PRD Review" --create-title "PRD Review" --create-body "跟踪 PRD 的 Review 过程。" --comment "<Review 结果>"`
将同样的结果输出给技术负责人。
