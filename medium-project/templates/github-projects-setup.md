...
| Module | Single select | `infra`, `{module-a}`, `{module-b}`, `web-app`, `admin`, ... |
...
# 模块标签
gh label create "module:infra" --color "fbca04" --description "基础设施"
...
# 需要 infra 变更时
gh issue comment {NUMBER} --body "需要修改 infra: {描述变更内容和用途}。请技术负责人确认。"
```
